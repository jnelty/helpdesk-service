 ...
 */
final class Version20250504104657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket_messages ADD ticket_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5E6BE217700047D2');
        $this->addSql('ALTER TABLE ticket_messages DROP ticket_id');
    }
}
